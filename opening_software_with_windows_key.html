...
<head>
  ...
  <title>Using the Windows Key | Team 23586</title>
...
<body>
  ...
  <div class="container">
    ...
    <section class="page-header">
      <h1><span class="gradient">Opening Software Without a Shortcut</span></h1>
      <p>A very in-depth explanation on how to use the complicated and powerful Windows key. <span class="badge windows">Windows Only</span></p>
    </section>

    <article class="content">

      <p>This page will teach you how to open up software with the Windows key. It's very helpful if you need to open an application that didn't or doesn't have a premade shortcut.</p>

      <h2>How To</h2>
      <ol>
        <li>Press the key that looks like the <strong>Windows logo</strong> on your keyboard. It should open up a big search box on your screen with some application icons below.</li>
        <li>Start typing in the name of the app you want to open.</li>
        <li>When the application's icon shows up, either click <strong>"Open"</strong> or just press <strong>Enter</strong> on your keyboard.</li>
      </ol>
      <img src="https://potatzz.github.io/23586/images/using-windows-key.png" alt="Using the Windows key to search for and launch an application">
      <p>That's it. You're a Windows power user now.</p>
    ...
    <footer>
      ...
      <div class="footer-links">
        ...
        <a href="/cdn-cgi/l/email-protection#7e1d0d0a17100d11104c473e0e0c17110c070e1f100a161b0c501d1113">Contact</a>
